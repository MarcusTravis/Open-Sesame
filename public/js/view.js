  ...
  function createNewRow(pw) {
    var $newInputRow = $(
      [
        ...
        pw.website,
        "</span>",
        "<input name='website' class='edit' style='display: none; size='5'>",
        "</td>",
        "<td class='pw-item'>",
        "<span>",
        pw.username,
        "</span>",
        "<input name='username' class='edit' style='display: none; size='5'>",
        "</td>",
        "<td class='pw-item'>",
        "<span>",
        pw.password,
        "</span>",
        "<input name='password' class='edit' style='display: none; size='5'>",
        "</td>",
        "<td>",
